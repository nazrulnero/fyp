...
if (isset($_POST['change'])) {
    ...
    $lectid = $_SESSION['lectid'];

    $con = "update tbllecturers set Password=:newpassword where id=:lectid";
    $chngpwd1 = $dbh->prepare($con);
    $chngpwd1->bindParam(':lectid', $lectid, PDO::PARAM_STR);
    ...
    <div class="mn-content fixed-sidebar">
        ...
        <aside id="slide-out" class="side-nav white fixed">
            <div class="side-nav-wrapper">
                ...
                <div class="footer">
                    <p class="Copyright"><a href="By Nazrul Nero">FYP</a>©</p>
                </div>
            </div>
        </aside>
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Lecturer Password Recovery</div>
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                                ...
                                <div class="row">
                                    <form class="col s12" name="signin" method="post">
                                        <div class="input-field col s12">
                                            <input id="lectid" type="text" name="lectid" class="validate" autocomplete="off" required>
                                            <label for="email">Lecturer ID</label>
                                        </div>
                                        <div class="input-field col s12">
                            ...
                            <?php if (isset($_POST['submit'])) {
                                $lectid = $_POST['lectid'];
                                $email = $_POST['emailid'];
                                $sql = "SELECT id FROM tbllecturers WHERE EmailId=:email and LectId=:lectid";
