...
if (strlen($_SESSION['alogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        $sql = "update tbllecturers set LectId=:lectid,FirstName=:fname,LastName=:lname,Gender=:gender,Room=:room,Section=:section,Nationality=:nationality,Phonenumber=:mobileno where id=:lid";
