...
if (strlen($_SESSION['lectlogin']) == 0) {
    ...
    if (isset($_POST['change'])) {
        ...
        $sql = "SELECT Password FROM tbllecturers WHERE EmailId=:username and Password=:password";
        ...
        if ($query->rowCount() > 0) {
            $con = "update tbllecturers set Password=:newpassword where EmailId=:username";
