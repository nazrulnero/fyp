...
if (isset($_POST['change'])) {
    ...
    $con = "update tblstudents set Password=:newpassword where id=:studid";
    $chngpwd1 = $dbh->prepare($con);
    $chngpwd1->bindParam(':studid', $studid, PDO::PARAM_STR);
...
<head>
    <!-- Title -->
    <title>Supervisor Designation System | Password Recovery</title>
...
<body>
    ...
    <div class="mn-content fixed-sidebar">
            ...
            <nav class="blue darken-1">
                <div class="nav-wrapper row">
                    ...
                    <div class="header-title col s3">
                        <span class="chapter-title">Supervisor Designation System</span>
                    </div>
                    </form>
                </div>
            </nav>
                    ...
                    <li class="no-padding">
                        ...
                        <div class="collapsible-body">
                            <ul>
                                ...
                                <li><a href="studForgotPassword.php">Password Recovery</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding">
                        <a class="collapsible-header waves-effect waves-grey"><i class="material-icons">account_box</i>Lecturer<i class="nav-drop-icon material-icons">keyboard_arrow_right</i></a>
                        <div class="collapsible-body">
                            <ul>
                                <li><a href="lecturer/">Login</a></li>
                                <li><a href="lectForgotPassword.php">Password Recovery</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="no-padding"><a class="waves-effect waves-grey" href="coordinator/"><i class="material-icons">account_box</i>Coordinator Login</a></li>
        ...
        <main class="mn-inner">
            <div class="row">
                <div class="col s12">
                    <div class="page-title">Student Password Recovery</div>
                    <div class="col s12 m6 l8 offset-l2 offset-m3">
                        <div class="card white darken-1">
                            <div class="card-content ">
                                <style>
                                    body {
                                        background-image: url('assets/images/studentdark.jpg');
                                        background-repeat: no-repeat;
                                        background-attachment: fixed;
                                        background-size: cover;
                                    }
                                </style>
                                <span class="card-title" style="font-size:20px;">Please enter</span>
                            ...
                            <?php if (isset($_POST['submit'])) {
                                $studid = $_POST['studid'];
                                $email = $_POST['emailid'];
                                $sql = "SELECT id FROM tblstudents WHERE EmailId=:email and StudId=:studid";
