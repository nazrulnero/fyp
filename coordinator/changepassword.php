...
if (strlen($_SESSION['coorlogin']) == 0) {
    ...
    if (isset($_POST['change'])) {
        ...
        $username = $_SESSION['coorlogin'];
        $sql = "SELECT Password FROM tblcoordinator WHERE UserName=:username and Password=:password";
        ...
        if ($query->rowCount() > 0) {
            $con = "update tblcoordinator set Password=:newpassword where UserName=:username";
